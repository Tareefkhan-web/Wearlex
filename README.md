# Wearlex — Premium Luxury E-Commerce Experience

Wearlex is a modern, responsive, and minimalist e-commerce frontend designed for a high-end fashion and luxury clothing brand. Built with semantic standard web technologies, it features an interactive interface, product showcases, smooth transitions, and a custom shopping cart system.
...
```text
Wearlex/
├── index.html        # Homepage with hero section & featured collections
├── shop.html         # Main store page with product catalog
